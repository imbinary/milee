...
void lsm303_stop();
void lsm303_poll();
volatile lsm303AccelData accelData;    // Last read accelerometer data will be available here
volatile lsm303MagData magData;        // Last read magnetometer data will be available here
